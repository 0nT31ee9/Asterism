...
(cl:defmethod cl:initialize-instance :after ((m <goal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'goal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_sim-msg:<goal> is deprecated: use lidar_sim-msg:goal instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_sim-msg:x-val is deprecated.  Use lidar_sim-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_sim-msg:y-val is deprecated.  Use lidar_sim-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_sim-msg:z-val is deprecated.  Use lidar_sim-msg:z instead.")
  (z m))
