...
(cl:defmethod cl:initialize-instance :after ((m <goal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'goal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ego_planner-msg:<goal> is deprecated: use ego_planner-msg:goal instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ego_planner-msg:x-val is deprecated.  Use ego_planner-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ego_planner-msg:y-val is deprecated.  Use ego_planner-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <goal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ego_planner-msg:z-val is deprecated.  Use ego_planner-msg:z instead.")
  (z m))
