...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    odom_sub_ = nh.subscribe("depth_goal_pose", 1, &EGOReplanFSM::odometryCallback, this);
  ...
  void EGOReplanFSM::odometryCallback(const nav_msgs::OdometryConstPtr &msg)
  {
    ...
    void EGOReplanFSM::Depth_goal(const ego_planner::goal &msg)
    {
        goal_pose(0) = msg.x;
        goal_pose(1) = msg.y;
        goal_pose(2) = msg.z;
