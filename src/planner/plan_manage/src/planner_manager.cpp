...
namespace ego_planner
{
  ...
  vector<vector<Eigen::Vector3d>> EGOPlannerManager::S_A(const double step_size, Eigen::Vector3d start_pt, Eigen::Vector3d end_pt)
  {
    vector<vector<Eigen::Vector3d>> a_star_pathes;
    a_star_pathes = bspline_optimizer_->seven_search(step_size, start_pt, end_pt);
